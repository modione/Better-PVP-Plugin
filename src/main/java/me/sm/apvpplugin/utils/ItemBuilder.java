 ...
 * @contributor Kev575
 */
@SuppressWarnings({"ALL", "JavaDoc", "UseBulkOperation", "ConstantConditions", "CopyConstructorMissesField", "SpellCheckingInspection"})
public class ItemBuilder {
    ...
    public ItemBuilder(Material itemFrame, Object o) {
    }
     ...
     */
    @SuppressWarnings({"InnerClassMayBeStatic", "SpellCheckingInspection"})
    public class Unsafe {
         ...
         */
        @SuppressWarnings({"SuspiciousRegexArgument", "SpellCheckingInspection"})
